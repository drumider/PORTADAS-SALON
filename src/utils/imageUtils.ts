...
const modules3 = (import.meta as unknown as { glob: Function }).glob('./assets/images/*', { eager: true }) as Record<string, any>;

const allModules: Record<string, any> = { ...modules1, ...modules2, ...modules3 };
